...
public class OrderLineItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4104504735546328041L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderLineItem\",\"namespace\":\"com.knoldus.model\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"size\",\"type\":{\"type\":\"enum\",\"name\":\"Size\",\"symbols\":[\"SMALL\",\"MEDIUM\",\"LARGE\"]}},{\"name\":\"quantity\",\"type\":\"int\"}]}");
  ...
  @Deprecated public com.knoldus.model.Size size;
   ...
   */
  public OrderLineItem(java.lang.CharSequence name, com.knoldus.model.Size size, java.lang.Integer quantity) {
    this.name = name;
    this.size = size;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: size = (com.knoldus.model.Size)value$; break;
   ...
   */
  public com.knoldus.model.Size getSize() {
    return size;
  }
   ...
   * @param value the value to set.
   */
  public void setSize(com.knoldus.model.Size value) {
    this.size = value;
  }
   ...
   */
  public static com.knoldus.model.OrderLineItem.Builder newBuilder() {
    return new com.knoldus.model.OrderLineItem.Builder();
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.knoldus.model.OrderLineItem.Builder newBuilder(com.knoldus.model.OrderLineItem.Builder other) {
    if (other == null) {
      return new com.knoldus.model.OrderLineItem.Builder();
    } else {
      return new com.knoldus.model.OrderLineItem.Builder(other);
    }
  }
   ...
   * @return A new OrderLineItem RecordBuilder
   */
  public static com.knoldus.model.OrderLineItem.Builder newBuilder(com.knoldus.model.OrderLineItem other) {
    if (other == null) {
      return new com.knoldus.model.OrderLineItem.Builder();
    } else {
      return new com.knoldus.model.OrderLineItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderLineItem>
    ...
    private com.knoldus.model.Size size;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.knoldus.model.OrderLineItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.knoldus.model.OrderLineItem other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.OrderLineItem.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.OrderLineItem.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.OrderLineItem.Builder setSize(com.knoldus.model.Size value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.OrderLineItem.Builder clearSize() {
      size = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.OrderLineItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.OrderLineItem.Builder clearQuantity() {
    ...
    public OrderLineItem build() {
      try {
        ...
        record.size = fieldSetFlags()[1] ? this.size : (com.knoldus.model.Size) defaultValue(fields()[1]);
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.size = com.knoldus.model.Size.values()[in.readEnum()];
