...
public class Store extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2613401664175963180L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Store\",\"namespace\":\"com.knoldus.model\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"address\",\"type\":{\"type\":\"record\",\"name\":\"Address\",\"fields\":[{\"name\":\"city\",\"type\":\"string\",\"doc\":\"city of the order\"},{\"name\":\"street\",\"type\":\"string\",\"doc\":\"Exact street address of the customer\"},{\"name\":\"zip\",\"type\":\"int\"}]}}]}");
  ...
  @Deprecated public com.knoldus.model.Address address;
   ...
   */
  public Store(java.lang.Integer id, com.knoldus.model.Address address) {
    this.id = id;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: address = (com.knoldus.model.Address)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.knoldus.model.Address getAddress() {
    return address;
  }
   ...
   * @param value the value to set.
   */
  public void setAddress(com.knoldus.model.Address value) {
    this.address = value;
  }
   ...
   */
  public static com.knoldus.model.Store.Builder newBuilder() {
    return new com.knoldus.model.Store.Builder();
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static com.knoldus.model.Store.Builder newBuilder(com.knoldus.model.Store.Builder other) {
    if (other == null) {
      return new com.knoldus.model.Store.Builder();
    } else {
      return new com.knoldus.model.Store.Builder(other);
    }
  }
   ...
   * @return A new Store RecordBuilder
   */
  public static com.knoldus.model.Store.Builder newBuilder(com.knoldus.model.Store other) {
    if (other == null) {
      return new com.knoldus.model.Store.Builder();
    } else {
      return new com.knoldus.model.Store.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Store>
    ...
    private int id;
    private com.knoldus.model.Address address;
    private com.knoldus.model.Address.Builder addressBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.knoldus.model.Store.Builder other) {
      super(other);
      ...
      if (other.hasAddressBuilder()) {
        this.addressBuilder = com.knoldus.model.Address.newBuilder(other.getAddressBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.knoldus.model.Store other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.Store.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.Store.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.Store.Builder setAddress(com.knoldus.model.Address value) {
     ...
     * @return This builder.
     */
    public com.knoldus.model.Address.Builder getAddressBuilder() {
      if (addressBuilder == null) {
        if (hasAddress()) {
          setAddressBuilder(com.knoldus.model.Address.newBuilder(address));
        } else {
          setAddressBuilder(com.knoldus.model.Address.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.knoldus.model.Store.Builder setAddressBuilder(com.knoldus.model.Address.Builder value) {
      clearAddress();
    ...
    /**
      ...
      * @return This builder.
      */
    public com.knoldus.model.Store.Builder clearAddress() {
      address = null;
      addressBuilder = null;
    ...
    public Store build() {
      try {
        ...
        if (addressBuilder != null) {
          ...
          record.address = fieldSetFlags()[1] ? this.address : (com.knoldus.model.Address) defaultValue(fields()[1]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.address == null) {
        this.address = new com.knoldus.model.Address();
      }
